...
author_profile: true
---
I am a Senior ML Researcher at Samsung Research UK, leading the Personalized AI part. My research interests lie in the adaptation of large language models (LLMs) within resource-constrained environments such as smartphones. Particularly, I am interested in: 
...
- decentralized training of models including LLMs for privacy-preservation (e.g., see our work on federated learning [WaCV'26](https://arxiv.org/pdf/2503.20138)),
- model merging to combine multiple LLMs or PEFT parameters for efficient deployment (see our work [EMNLP'25](https://aclanthology.org/2025.emnlp-main.1365.pdf)),
